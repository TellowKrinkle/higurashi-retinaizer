...
## Compiling
Compile with `clang -fno-rtti -fno-objc-exceptions -fno-exceptions -mmacosx-version-min=10.7 -shared -O3 -flto=full -framework Cocoa -framework OpenGL -framework Carbon Retinaizer.mm Replacements.mm -o libRetinaizer.dylib`
