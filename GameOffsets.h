...
static const struct AllOffsets TatarigoroshiOldOffsets = {
	.screenManager = {
		...
		.backBufferColorSurface = 0xc8_i,
		.backBufferDepthSurface = 0xd0_i,
	},
	.gfxDevice = {
...
static const struct AllOffsets TatarigoroshiNewOffsets = {
	.screenManager = {
		...
		.renderColorSurface = 0x88_i,
		.renderDepthSurface = 0x90_i,
		.backBufferColorSurface = 0xd0_i,
		.backBufferDepthSurface = 0xd8_i,
		.renderTargetSetup = 0xe0_i,
	},
	.gfxDevice = {
		...
		.SetViewport = 0x130_v,
		.DeallocRenderSurface = 0x308_v,
		.AcquireThreadOwnership = 0x430_v,
		.ReleaseThreadOwnership = 0x438_v,
		.renderer = 0x11cc_i,
	},
	.gfxFramebufferGLES = {
		.framebufferOld = 0x220_i,
	},
	.playerSettings = {
...
static const struct AllOffsets MeakashiOffsets = {
	...
	.gfxDevice = {
		...
		.AcquireThreadOwnership = 0x440_v,
		.ReleaseThreadOwnership = 0x448_v,
	},
	.gfxFramebufferGLES = {
		.framebufferNew = 0x240_i,
	},
	.playerSettings = {
...
static const struct AllOffsets MinagoroshiOffsets = {
	.screenManager = {
		...
		.renderColorSurface = 0x88_i,
		.renderDepthSurface = 0x90_i,
		.backBufferColorSurface = 0x98_i,
		.backBufferDepthSurface = 0xa0_i,
	},
	.gfxDevice = {
